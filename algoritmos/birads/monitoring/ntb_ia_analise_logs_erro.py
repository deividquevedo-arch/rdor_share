...
icon = "https://freesvg.org/img/1538154274.png"
...
payload = build_email(environment, data_execucao_modelo, tentativas, df, df_errors, config)
send_email(config["emailUrl"], payload)
