...
print("main_catalog:", environment_tbl)

# COMMAND ----------

# DBTITLE 1,Define variáveis com nomes das tabelas
tbl_saida = f"{catalog_name}.{environment_tbl}tb_diamond_mod_{id_projeto}_saida_v2"
print(tbl_saida)
...
def format_excel(full_file_name, dic_col_names, dic_col_fixed_width):
    ...
    dv_achado = DataValidation(type="list", formula1='"1 - Sim (Tem doença bilar),2 - Não"', allow_blank=True)
