...
| --------------- | ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| Hepatologia     | ativo_hml_prd                         | `azure-pipelines.yml` com trigger hml/main + fluxo completo `data/model/serving/monitoring` e tabelas `tb_diamond_mod_hepatologia`_*.   |
