...
**Nota:** o schema abaixo e o formato completo para Fase 3+ (com campos de encoder e head). Na Fase 1, o schema e simplificado: sem `encoder_model`, `head_checkpoint`, e `head_config` usa apenas `threshold` e `confidence_levels`.
...
| Colon | ativo PRD | Grupo 1b | Unificar CONFIG | Manter embeddings | Head encoder | + scoring + calibracao |
...
| Pulmao | ativo PRD | Grupo 1b | Unificar CONFIG | Manter embeddings | Head encoder | + scoring + calibracao |
