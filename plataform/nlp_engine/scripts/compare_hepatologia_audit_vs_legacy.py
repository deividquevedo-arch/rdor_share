#!/usr/bin/env python3
"""Compara auditoria do motor Hepatologia vs saida legado (mesmo input)."""
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Comparar Hepatologia: audit motor vs saida legado")
